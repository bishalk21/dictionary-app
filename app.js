...
async function render() {
  ...
  const data = await fetch(`${baseApi}${word}`).then((response) =>
    response.json()
  );
  ...
  if (data.title === "No Definitions Found") {
    ...
    nf.innerHTML = `<img src="https://t1.gstatic.com/licensed-image?q=tbn:ANd9GcRQSIMQVA8tMJ2_UB9qdIBk_vdKNoWuQEHSPIiwQ6FYursjTRQ00NFQqGoE1u7fBq7c" alt="" srcset="">
                        <p>Not Found</p>`;
    body.appendChild(nf);
    return;
  }
